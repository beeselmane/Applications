...
typedef struct IOMobileFramebufferDisplaySize {
    double width;
    double height;
...
IOMobileFramebufferReturn IOMobileFramebufferGetDisplaySize(IOMobileFramebufferConnection connection, IOMobileFramebufferDisplaySize *t);
IOMobileFramebufferReturn IOMobileFramebufferIsMainDisplay(IOMobileFramebufferConnection connection, bool *isMain);
